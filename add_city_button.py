...
class AddCityButton(MyAddButton):
    ...
    def create_add_window(self, parent):
        ...
        self.city_entry = HelperEntry(add_window, helper_text='City')
        ...
        self.country_entry = SearchCombobox(add_window, helper_text='Country', values=country_values)
        ...
        add_button = ttk.Button(add_window, text='Add', command=lambda: self.add_city(add_window),
